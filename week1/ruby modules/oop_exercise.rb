# (done) 1. Write out the Card and Deck classes to make the program work. The Deck class should hold a list of Card instances.
...
class Deck
  def initialize(options)
    ...
    options.each do |item|
      @deck << Card.new(question:item[0], answer:item[1])
    end
  end

  def draw_card
    #TODO - draw a random card from deck, and pop it out
