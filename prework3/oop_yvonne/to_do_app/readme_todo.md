...
#3. Answer the following questions regarding oop_todo.rb:
	#a. Explain line 5. #creates a new object from the List class
    #b. Explain line 8. #calls the method add_task on the new object named 'list'
    #c. Explain line 14. #prints out the name property from the 2nd element in the task array of the list object.
    #d. Explain line 31. #calls the complete! method on the 1st element in the task array of the list object.

#4. Answer the following questions:
    #a. In your opinion, what advantages does oop_todo have over procedural_todo? #OOP code follows the DRY approach while makes it read and run more efficiently.
    #b. In your opinion, what advantages does procedural_todo have over oop_todo? #Procedural coding is linear and you can read the code from top to bottom.
